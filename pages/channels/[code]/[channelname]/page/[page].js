    ...
    return (
        <>
            ...
            <Head>
                ...
                <title>{`Free ${capitalizeFirstLetter(channel_name.replace('+', " ").replace("+", " "))} Porn Videos - CumCraze | ${currentPageNumberURL}`}</title>
                ...
                <link rel="canonical" href={`https://www.cumcraze.com/channels/${code}/${channelname}/page/${page}`} />
