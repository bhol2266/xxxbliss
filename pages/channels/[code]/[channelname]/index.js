...
<Head>
                <title>{`Free ${capitalizeFirstLetter(channel_name.replace('+', " ").replace("+", " "))} Porn Videos - XXXBliss`}</title>
                ...
                <link rel="canonical" href={`https://www.XXXBliss.com/channels/${code}/${channelname}`} />
