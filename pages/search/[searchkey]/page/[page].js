    ...
    return (
        <>
            <Head>
                ...
                <title>{`${capitalizeFirstLetter(searchkey.replace('+', " ").replace("+", " "))} Porn Videos - XXXBliss | ${currentPageNumberURL}`}</title>
                ...
                <link rel="canonical" href={`https://www.XXXBliss.com/search/${searchkey}/page/${page}`} />
