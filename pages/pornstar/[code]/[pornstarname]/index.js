...
function Index({ video_collection, pages, pornstarInformation, collageImages }) {
    ...
    return (
        <>
           <Head>
                <title>{`${capitalizeFirstLetter(pornstarname.replace('+', " ").replace("+", " "))} Porn Videos - XXXBliss`}</title>
                ...
                <link rel="canonical" href={`https://www.XXXBliss.com/pornstar/${code}/${pornstarname}`} />
            </Head>
